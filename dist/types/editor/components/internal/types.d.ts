 ...
 * `{ title: 'Khmer Font', fontFaces: ['editor-Battambang', …] }`. The title is
...
/**
 * Language support (the km-KH kind): keyboard, spellcheck, fonts. Only the
 * keys the host validates are typed; the rest is plugin-defined.
 */
