...
declare class MonacoFeatureController {
    ...
    getKhmerSegmentationSelectedEntries(): {
        entries: any;
        hasNonEmptySelection: boolean;
    };
    getKhmerSegmentationLineEntryAtPosition(position: any): {
        range: {
    ...
    getKhmerSegmentationLineEntryFromMouseTarget(target: any): {
        range: {
            startLineNumber: number;
            startColumn: number;
            endLineNumber: number;
    ...
    getKhmerSegmentationFallbackEntry(): any;
    getKhmerSegmentationSelections(): any;
    updateKhmerSegmentationContextMenuTarget(target: any): void;
    clearKhmerSegmentationContextMenuTarget(): void;
    updateKhmerSegmentationSelectionContextKey(): void;
    ...
    applyKhmerSegmentationToSelection(): Promise<any>;
    formatLineWhitespace(lineContent: any): string;
