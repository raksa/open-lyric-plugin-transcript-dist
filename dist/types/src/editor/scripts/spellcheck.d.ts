...
declare function applySegmentationMarkerEdit(editor: any, marker: any): Promise<boolean>;
...
export { ADD_TO_CUSTOM_DICTIONARY_COMMAND_ID, applySegmentationMarkerEdit, checkSpellcheckWordValidity, clearSpellcheckMarkers, getModelSpellcheckMarkers, handleSpellcheckContentChange, loadAutocompleteSpellcheckSuggestions, postProcessTranscriptText, pruneSpellcheckCustomDictionaryWords, refreshSpellcheckNow, scheduleSpellcheck, setSpellcheckCustomDictionaryWords, setSpellcheckExcludedWords, };
